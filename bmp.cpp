...
// pliku binarnego. Więcej informacji:
...
public:
  ...
  // Operator przeznaczony do użycia z binarnym zapisem do pliku.
...
private:
  ...
  // - przesunięcie (offset) od początku pliku do danych bitmapy
  ...
  //   8 - 256 kolorów; 24 - 16,7 milionów kolorów)
  ...
  // - rozmiar danych obrazu w bajtach; jeśli nie ma kompresji to można ustawić
  // wartość 0
